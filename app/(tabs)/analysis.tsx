    ...
    return (
        <View className="flex-1 bg-slate-50 dark:bg-slate-900">
            ...
            <View className="flex-row p-4 gap-2">
                <ScaleButton label="日" value="day" />
                <ScaleButton label="月" value="month" />
                <ScaleButton label="年" value="year" />
            </View>
            ...
            <ScrollView className="flex-1 p-4" showsVerticalScrollIndicator={false}>
                ...
                {timeScale === 'day' && (
                    <View className="mb-4">
                        <Text className="text-sm font-bold text-slate-400 dark:text-slate-500 mb-2 uppercase tracking-wide">日別の収支推移</Text>
                        <DailyTrendBarChart transactions={filteredTransactions} />
                    </View>
                )}
